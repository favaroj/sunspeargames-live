...
import ZenithBornFactionImage from './../Assets/img/minified/splash-zenithborn.jpg'
...
export default class ZenithBornFaction extends Component {
    constructor() {
        super();
        this.state = {
            width: 0,
        ...
        return (
            <div className="App">
                {this.state.width > 768
                    ? <Parallax bgImage={ZenithBornFactionImage} strength={550} style={{height: 850}}>
              ...
              <div className='sections set-zindex-top'>
                <div className='container set-zindex-top'>
                  <div className='set-zindex-top'>
                    ...
                    : <div className='zenithBorn-faction-mobile-container' style={{background: ZenithBornFactionImage}} >
                        <div className='anti-shadow'>
                            <div className='sections set-zindex-top'>
                                {/*<div className='container set-zindex-top'>
                  <div className='set-zindex-top'>
